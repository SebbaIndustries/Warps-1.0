...
public class MoveCompletion implements TabCompleter {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        if (strings.length == 2) {
            ...
            if (player.hasPermission("warps.command.movewarp.official") || player.hasPermission("warps.command.movewarp.admin"))
